...
parser.add_argument('--lr_F', type=float, default=3.0, help='Forward learning rate')
parser.add_argument('--lr_B', type=float, default=3.0, help='Backward learning rate')
...
wandb.init(project="opt-ccl-classfication", name=run_name, config=args)
...
# Define fixed 
if args.dataset == "MNIST" or args.dataset == "CIFAR10" or args.dataset == "FashionMNIST": # from 0 - 9
