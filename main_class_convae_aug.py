...
parser.add_argument('--task_transform', type=str, default="shifth5", help='Random seed')
...
wandb.init(project="opt-cll-cnn-autoencoder-aug", name=run_name, config=args)

# unique run name for saving models, to inlcude dataset, method, task, and transform, lr, act, bn, mmt, grad_clip
unique_run_name = f"{args.dataset}_{args.method}_{args.task_transform}_{args.act_F}_{args.act_B}_{args.fw_bn}_{args.bw_bn}_{args.mmt_F}_{args.mmt_B}_{args.grad_clip_F}_{args.grad_clip_B}_{args.wd_F}_{args.wd_B}_{args.seed}_aug"
unique_run_name += f"{args.loss_scale_C}_{args.loss_scale_D}"
